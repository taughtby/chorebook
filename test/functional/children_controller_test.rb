...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { dob: @child.dob, image: @child.image, name: @child.name, total_points: @child.total_points }
    end
  ...
  test "should update child" do
    put :update, id: @child, child: { dob: @child.dob, image: @child.image, name: @child.name, total_points: @child.total_points }
    assert_redirected_to child_path(assigns(:child))
  end
